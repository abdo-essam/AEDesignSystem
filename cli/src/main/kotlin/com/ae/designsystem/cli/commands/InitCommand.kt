...
class InitCommand : CliktCommand(name = "init") {
    ...
    override fun help(context: Context) = "Initialize AEDesignSystem in your project"
    ...
    override fun run() {
        if (ConfigManager.exists()) {
            echo("ae.json already exists. Overwrite? (y/N) ", trailingNewline = false)
        ...
        echo("")
        echo("  Then run: aedesignsystem add button")
        echo("")
    }
